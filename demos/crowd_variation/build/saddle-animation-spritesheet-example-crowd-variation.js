function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./saddle-animation-spritesheet-example-crowd-variation_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('saddle-animation-spritesheet-example-crowd-variation_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
